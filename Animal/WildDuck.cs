...
namespace Animal
{
    public class WildDuck: Animals, ISwim, IFly, IWalk
    {
        private string name;
        ...
        {
            Console.WriteLine($"Hello! My name is {this.name}, I am a {this.GetType().Name}, part of {this.category} and I crawl at {this.maxSpeed}");
        }
    }
}
